...
uint256 hashGenesisBlock("0x6ea32e0f9787726c1f20b66710fff95341358b03b8939307f12d6c86124a38ce");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // TielnetCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "TielnetCoin Signed Message:\n";
...
{
    // TielnetCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // TielnetCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // TielnetCoin: 3.5 days
static const int64 nTargetSpacing = 150; // TielnetCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // TielnetCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // TielnetCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // TielnetCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x12f62d4b4d7b5e5da7d74ee386f244b404dc6a3070df17f2b6202b7e7c31d70e");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("b180b9c94c435f6654853b296ce4b3d6ec947352ad7893d60cab15da17f57f42db647b05ab14aa587e3cb57196281c56af2d0ad4ade1da9fbce0e92268693bb834") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1450629620;
        block.nBits    = 504365644;
        block.nNonce   = 4254091848;

        if (fTestNet)
        {
            block.nTime    = 1450629620;
            block.nNonce   = 1503947753;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x6b4e34aa9db0906897d8efa293611440e1bdb59584110914394149225f50e681"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // TielnetCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TielnetCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TielnetCoinMiner : ProcessBlock, block not accepted");
    }
